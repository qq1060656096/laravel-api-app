...
class SwaggerUserRefClassController
{
    /**
     * @param $uid
     * @OA\Get(
     *      path="/swagger-user-ref-class/{uid}",
     *      operationId="getDemoUser",
     *      tags={"swagger用户ref-class"},
     *      summary="获取用户详情",
     *      description="获取用户详情",
     *      @OA\Parameter(
    ...
    /**
     * @OA\Post(
     *     path="/swagger-user-ref-class/post-json",
     *     tags={"swagger用户ref-class"},
     *     summary="创建用户",
     *     description="创建用户",
    ...
    /**
     * @OA\Post(
     *     path="/swagger-user-ref-class/post-form-data",
     *     tags={"swagger用户ref-class"},
     *     summary="创建用户",
     *     description="创建用户",
     *     operationId="postDemoUser",
     ...
     *            @OA\Schema(
     *                  ref="#/components/schemas/swagger_user_schema"
     *              )
     *        )
     *    ),
     *     @OA\Response(
